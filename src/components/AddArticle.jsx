...
const AddArticleForm = () => {
  ...
  const handleImageChange = (e) => {
    ...
    setImages(files); // Guarda los archivos directamente en el estado
  };

  const handleSubmit = async (e) => {
    e.preventDefault();

    // Crear un objeto FormData para manejar archivos e información
    ...
    try {
      const response = await axios.post(`${apiUrl}/api/addarticle`, formData, {
